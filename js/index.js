...
//  document.body.style.background = "#f525"; // Change to your desired color
const clear = document.querySelector(".clear");
// to clesr the local storage
...
var randomWord =
  ...
  todayContainer.innerHTML = randomWord + n + " " + d.getDate() + " " + monthNames[d.getMonth()] + " " + d.getFullYear();
